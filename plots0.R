...
name_file <- paste0(Dir,'discharge/events/performance_A.txt')
dataA <- read.table(name_file,header=TRUE)
name_file <- paste0(Dir,'discharge/events/performance_B.txt')
...
name_file <- paste0(Dir,'discharge/events/performance_C.txt')
dataC <- read.table(name_file,header=TRUE)
name_file <- paste0(Dir,'discharge/events/performance_D.txt')
...
name_file <- paste0(Dir,'discharge/events/performance_E.txt')
...
name_file <- paste0(Dir,'head/events/performance_A.txt')
dataA.h <- read.table(name_file,header=TRUE)
name_file <- paste0(Dir,'head/events/performance_B.txt')
...
name_file <- paste0(Dir,'head/events/performance_C.txt')
dataC.h <- read.table(name_file,header=TRUE)
name_file <- paste0(Dir,'head/events/performance_D.txt')
...
name_file <- paste0(Dir,'head/events/performance_E.txt')
